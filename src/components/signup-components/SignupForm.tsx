...
import { signupAction } from "@/app/actions/signup-actions";
import {
    AtSymbolIcon,
    KeyIcon,
...
export default function SignupForm() {
    ...
    return (
        <form action={formAction}>
            <h1 className="mb-3 text-3xl">Please sign up to continue.</h1>
            <div className="">
                <div>
                    <label
                ...
                <div className="mt-4">
                    ...
                    <div className="mt-5">
                        ...
                        <ul className="mt-3">
                            <li className="ps-5">At least one letter</li>
                            <li className="ps-5">At least one number</li>
                            <li className="ps-5">
